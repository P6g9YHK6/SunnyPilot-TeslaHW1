> **Fork notice:** This repository is a fork of [sunnyhaibin/sunnypilot](https://github.com/sunnyhaibin/sunnypilot), which is a fork of [commaai/openpilot](https://github.com/commaai/openpilot). Built for the purpose of adding **Tesla Hardware 1** support to sunnypilot. The HW1 work is based on [xnor](https://github.com/xnor-tech/openpilot), is the successor of [Tinkla (Unity)](https://github.com/BogGyver/openpilot).
